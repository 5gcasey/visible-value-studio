  ...
  const { data: meetings, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from("meetings")
        .select("id, title, body, executive_summary, meeting_date, meeting_type, location, status, agenda_url, agenda_pdf_url, video_url, video_stream_url, minutes_url, transcript_url, transcript_text")
